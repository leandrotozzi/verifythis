...
- [ ] Que los métodos se ejecutan más rápido
...
- [ ] 10, una por objeto
- [ ] 0 hasta que alguien la escribe
...
- [x] No: cada especialización del parámetro es una clase distinta, con su propia queue
...
- [x] Decidir en tiempo de ejecución qué subtipo construir, sin hardcodear el `new`
- [ ] Evitar tener que declarar clases
- [ ] Copiar objetos sin compartir el handle

> **Decidir el subtipo en runtime** — le pedís un objeto a la fábrica y ella decide cuál. Es la pieza que después te va a dejar cambiar el estímulo de un test entero sin tocar el código del `env`.
