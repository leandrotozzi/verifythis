...
- [x] `|=>`, porque lo que se escribe con `<=` se lee un flanco después
- [ ] Cualquiera de las dos: la diferencia es de estilo
- [ ] Ninguna: para señales registradas hay que usar `$past()` sobre el antecedente
...
- [x] Una assertion en la interface: es un bug de **protocolo**
- [ ] El `uvm_fatal` del `command_monitor`, que dejaría de ver comandos en el bus
