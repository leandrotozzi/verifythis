...
#### *Sequences virtuales: el problema*
...
- Y cuando hay **más de un sequencer**, la que compone es una **sequence
  ...
  coordina las dos interfaces — `code/u7/sequences/virtual/`
- Con **dos sequences sobre el mismo sequencer** el que reparte es el sequencer:
  ...
  se puede intercalar
- Con esto el testbench del curso está completo, y es la forma en que se escribe
  hoy en la industria
