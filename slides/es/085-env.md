...
![set_type_override_by_type: la factory devuelve add_tester donde se pide base_tester](res/diagrams/env_uvm_incantation_2.svg)
<!-- .element: class="grande" -->
...
- `factory.print(0)` es la contraparte de `+TOPOLOGY`: uno dice lo que
...
La regla práctica: la ruta es la que imprime `+TOPOLOGY`, sin el `<unnamed>` de
