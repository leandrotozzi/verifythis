...
<!-- .slide: data-machete="res/en/machete-debug.svg|Debug cheat sheet: the seven knobs of the course and what to look at for each symptom,res/en/uvm_class_diagram.svg|The UVM base class hierarchy" -->
...
work: measuring is half of it, closing is the other half. The last two exercises
of the afternoon are two thirds of that cycle —measure the `dist`, close the
bin— and day 7 closes it by accumulating seeds.
