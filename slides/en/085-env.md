...
Note:
The macro is what replaces the `case` of the hand-written factory of the factory: each class signs itself up in the dictionary, and adding a type does not force you to
edit the factory.
...
- The three arguments are the usual ones: the **name** that is going to come out in the
