...
| 5 | 1 | Interfaces y BFM | **a** | **Deja de hablar en señales** — el BFM traduce *una operación* a *un handshake de señales*. El tester no vuelve a tocar un cable; el scoreboard y el coverage siguen leyéndolos, por la interface, hasta que un monitor les mande transactions. Es el primer paso hacia UVM. |
