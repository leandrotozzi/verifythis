...
module top;
   ...
   typedef enum bit[2:0] {no_op  = 3'b000,
                          ...
                          xor_op = 3'b100,
                          mul_op = 3'b101,
                          // TODO(ejercicio 1): falta shr_op = 3'b110
   ...
   covergroup op_cov;
      coverpoint op_set {
         ...
         // TODO(ejercicio 1): shr_op tambien es de un ciclo, y el rango
         // [add_op:xor_op] llega hasta 3'b100: no lo alcanza
...
`endif
   ...
   always @(posedge done) begin : scoreboard
      ...
      case (op_set)
        ...
        // TODO(ejercicio 1): falta el caso de shr_op
      endcase // case (op_set)
