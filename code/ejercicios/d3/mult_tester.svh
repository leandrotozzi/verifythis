...
//
// Look at code/u4/env/tb_classes/add_tester.svh: it is exactly the same idea with
// another operation. Do not forget the `uvm_component_utils or the constructor.
